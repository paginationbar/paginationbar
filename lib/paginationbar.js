...
class f {
  constructor(e) {
    ...
    l(this, "currentJumpNumber", "");
    l(this, "selectedPageSize", this.options.pageSize);
    ...
    p(t, n.containerClassName), p(
      t,
      `${n.themeClassNamePrefix}${this.options.theme}`
    ), this.options.disabled && p(t, "disabled"), this.render();
  }
  ...
  setTheme(e) {
    ...
    for (const i of t.classList.values())
      i.startsWith(n.themeClassNamePrefix) && h(t, i);
    p(t, `${n.themeClassNamePrefix}${e}`);
  }
  disabled(e, t = !0) {
    const i = this.getContainerEl();
    this.options.disabled = e, e ? p(i, "disabled") : h(i, "disabled"), t && this.render();
  }
  get pageCount() {
