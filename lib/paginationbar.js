...
class d {
  constructor(e) {
    ...
    this.options = Object.assign(this.options, e), this.selectedPageSize = this.options.pageSize, this.pagerListener = this.pagerListener.bind(this), this.prevBtnListener = this.prevBtnListener.bind(this), this.nextBtnListener = this.nextBtnListener.bind(this), this.jumperListener = this.jumperListener.bind(this), this.sizesListener = this.sizesListener.bind(this), this.render();
  }
  ...
  generatePager() {
    const e = this.finalPager.reduce((t, i) => {
      ...
      return t += `<li class="${n.pagerItemClassName} ${a}" data-number="${i.pageNumber}" data-type="${i.type}" role="${p}">${r}</li>`, t;
    }, "");
