...
import { removeClass as l, addClass as h, css as u } from "fourdom";
...
class C {
  ...
  setTheme(e) {
    ...
    for (const i of t.classList.values())
      i.startsWith(n.themeClassNamePrefix) && l(t, i);
    h(t, `${n.themeClassNamePrefix}${e}`);
  }
  disabled(e, t = !0) {
    const i = this.getContainerEl();
    this.options.disabled = e, e ? h(i, "disabled") : l(i, "disabled"), t && this.render();
  }
  get pageCount() {
  ...
  render() {
    const e = this.getContainerEl();
    this.options.hideOnSinglePage && this.options.total === 1 ? u(e, { display: "none" }) : u(e, { display: "flex" }), e.innerHTML = this.getLayoutHTML(), this.registerListeners();
  }
  destory() {
    this.removeListeners();
  }
