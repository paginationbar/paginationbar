...
class f {
  ...
  getContainerEl() {
    if (typeof this.options.container == "string") {
      ...
      if (!e)
        throw new Error(h.getContainerElError);
      return e;
    }
  ...
  generatePager() {
    const e = this.finalPager.reduce((t, i) => {
      const r = `
        ...
        <span class="pager-quick-btn-icon pager-quick-btn-icon--arrow ${i.type}">${b}</span>
  ...
  generatePrev() {
    const e = this.options.currentPage <= this.options.firstPageNumber ? 'disabled="disabled"' : "", t = e ? "disabled" : "", i = this.options.prevText ? this.options.prevText : d;
    return `<button type="button" class="${n.prevButtonClassName} ${t}" ${e} role="prev-btn">${i}</button>`;
  }
  generateNext() {
    const e = this.options.currentPage >= this.lastPageNumber ? 'disabled="disabled"' : "", t = e ? "disabled" : "", i = this.options.nextText ? this.options.nextText : P;
