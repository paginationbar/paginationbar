...
class f {
  constructor(e) {
    ...
    h(this, "currentJumpNumber", "");
    h(this, "selectedPageSize", this.options.pageSize);
    ...
    u(t, n.containerClassName), u(
      t,
      `${n.themeClassNamePrefix}${this.options.theme}`
    ), this.options.disabled && u(t, "disabled"), this.render();
  }
  ...
  setTheme(e) {
    ...
    for (const i of t.classList.values())
      i.startsWith(n.themeClassNamePrefix) && p(t, i);
    u(t, `${n.themeClassNamePrefix}${e}`);
  }
  disabled(e, t = !0) {
    const i = this.getContainerEl();
    this.options.disabled = e, e ? u(i, "disabled") : p(i, "disabled"), t && this.render();
  }
  get pageCount() {
  ...
  getContainerEl() {
    if (typeof this.options.container == "string") {
      ...
      if (!e)
        throw new Error(l.getContainerElError);
      return e;
    }
  ...
  generatePrev() {
    const e = this.options.currentPage <= this.options.firstPageNumber || this.options.disabled ? 'disabled="disabled"' : "", t = e ? "disabled" : "", i = this.options.prevText ? this.options.prevText : d;
    return `<button type="button" class="${n.prevButtonClassName} ${t} ${this.isBackground()}" ${e} role="prev-btn">${i}</button>`;
  }
  generateNext() {
    const e = this.options.currentPage >= this.lastPageNumber || this.options.disabled ? 'disabled="disabled"' : "", t = e ? "disabled" : "", i = this.options.nextText ? this.options.nextText : b;
  ...
  render() {
    ...
    e.innerHTML = t, this.registerListeners();
  }
  destory() {
    this.removeListeners();
  }
